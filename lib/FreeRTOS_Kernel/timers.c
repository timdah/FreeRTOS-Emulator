...
/* KHCHEN: m ordered lists, i.e., m = max(1, ceiling(log_2(n))-1) and one bucket (list) 
 * Assumption here is that the number of tasks and the periods are given, so that 
 * the multiple lists can be created beforehand. .
 *
